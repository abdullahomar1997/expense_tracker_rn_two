...
import { getFirestore, serverTimestamp, collection, query, orderBy, onSnapshot, updateDoc, doc } from 'firebase/firestore';
...
const UpdateScreen = ({route, navigation}) => {
  ...
  const ExpenseRef = doc(db, 'expense', itemId); // Construct document reference
