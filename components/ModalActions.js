...
import { getFirestore,deleteDoc, serverTimestamp, collection, query, orderBy, onSnapshot, updateDoc, doc } from 'firebase/firestore'; 

const ModalActions = ({modalVisible, setModalVisible, navigation, id}) => {

  const ExpenseRef = doc(db, 'expense', id); // Construct document reference
